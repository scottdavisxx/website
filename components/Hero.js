const Hero = () => {
  return (
    <div className="flex flex-col bg-prim-light justify-center pt-16 xl:pt-5 pb-5">
      ...
      <h2 className="text-comp-lighter text-center text-4xl my-4 font-bold leading-10 mt-10 w-10/12 self-center">
        I am a passionate Software Developer with years of experience building
        Web Apps and large websites.
      </h2>
      <p className="w-10/12 self-center text-comp-lighter text-center text-xl my-4 font-semibold">
