...
const SkillsWithIntro = () => {
  return (
    <div className="bg-prim-darker flex flex-col items-center justify-between">
      ...
      <p className="text-white w-5/6 text-center my-2 text-2xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem nec dictumst neque, 
        ...
        risus, orci ut a libero. Eu turpis donec sodales egestas facilisi eget.
      </p>
